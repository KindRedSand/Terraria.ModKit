...
namespace Razorwing.Framework.IO.File
{
    public static class FileSafety
    {
        ...
        //                        return FileType.Zip;
        //#if P2P
        //                    case "Razorwingmagnet":
        //                        return FileType.OsuMagnet;
        //#endif
        //                    case "osc":
        //                        return FileType.OsuM; //Razorwing!stream
        //                    case "ogg":
        //                    case "mp3":
        ...
        {
            string directory = Path.Combine(Path.GetTempPath(), @"Razorwing!");
