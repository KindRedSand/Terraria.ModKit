...
namespace Terraria.ModKit.UIElements
{
	class UISlider : UIElement
	{
		...
		protected override void DrawSelf(SpriteBatch spriteBatch)
        {
			...
			spriteBatch.Draw(GameContent.TextureAssets.ColorBar.Value, rectangle, Color.White);
			if (IsMouseHovering) spriteBatch.Draw(GameContent.TextureAssets.ColorHighlight.Value, rectangle, Main.OurFavoriteColor);
			...
			for (float i = 0f; i < rectangle.Width; i += 1f)
			{
				...
				spriteBatch.Draw(GameContent.TextureAssets.ColorBlip.Value, new Vector2(x + i * scale, y),
			...
			spriteBatch.Draw(GameContent.TextureAssets.ColorSlider.Value,
				new Vector2(x + rectangle.Width * scale * percent, y + 4f * scale),
				null, Color.White, 0f,
				new Vector2(0.5f * (float)GameContent.TextureAssets.ColorSlider.Value.Width, 0.5f * (float)GameContent.TextureAssets.ColorSlider.Value.Height),
