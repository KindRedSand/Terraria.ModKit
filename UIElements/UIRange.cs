...
//using Terraria.ModKit.Tools.Dusts;
...
//				minus = new UIImageButton(Terraria.ModKit.instance.GetTexture("UIElements/ButtonMinus"));
...
//				plus = new UIImageButton(Terraria.ModKit.instance.GetTexture("UIElements/ButtonPlus"));
