...
namespace Terraria.ModKit.UIElements
{
	class NewUITextBoxMultiLine : UITextPanel<string>
	{
		...
		protected override void DrawSelf(SpriteBatch spriteBatch)
		{
			...
			Main.spriteBatch.Draw(REPLTool.magicPixel, hitbox, Color.LightCyan * 0.6f);
			...
			DynamicSpriteFont spriteFont = base.IsLarge ? GameContent.FontAssets.DeathText.Value : GameContent.FontAssets.MouseText.Value;
